...
class TransferrableOrganization(object):
    ...
    def __init__(self, transferrable=None, new_billable_members=None, restricted_members=None):  # noqa: E501
        """TransferrableOrganization - a model defined in Swagger"""  # noqa: E501
    ...
    def transferrable(self):
        """Gets the transferrable of this TransferrableOrganization.  # noqa: E501


        :return: The transferrable of this TransferrableOrganization.  # noqa: E501
        :rtype: bool
        """
    ...
    def transferrable(self, transferrable):
        """Sets the transferrable of this TransferrableOrganization.


        :param transferrable: The transferrable of this TransferrableOrganization.  # noqa: E501
        :type: bool
        """
    ...
    def new_billable_members(self):
        """Gets the new_billable_members of this TransferrableOrganization.  # noqa: E501


        :return: The new_billable_members of this TransferrableOrganization.  # noqa: E501
    ...
    def new_billable_members(self, new_billable_members):
        """Sets the new_billable_members of this TransferrableOrganization.


        :param new_billable_members: The new_billable_members of this TransferrableOrganization.  # noqa: E501
    ...
    def restricted_members(self):
        """Gets the restricted_members of this TransferrableOrganization.  # noqa: E501


        :return: The restricted_members of this TransferrableOrganization.  # noqa: E501
        :rtype: list[PendingOrganizationsTransferabilityNewBillableMembers]
        """
    ...
    def restricted_members(self, restricted_members):
        """Sets the restricted_members of this TransferrableOrganization.


        :param restricted_members: The restricted_members of this TransferrableOrganization.  # noqa: E501
        :type: list[PendingOrganizationsTransferabilityNewBillableMembers]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransferrableOrganization, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransferrableOrganization):
            return False
